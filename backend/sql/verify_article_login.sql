...
IF ISNULL(HAS_PERMS_BY_NAME(N'web.ListAdminArticles', N'OBJECT', N'EXECUTE'), 0) <> 1
   ...
   OR ISNULL(HAS_PERMS_BY_NAME(N'web.UnpublishArticle', N'OBJECT', N'EXECUTE'), 0) <> 1
   OR ISNULL(HAS_PERMS_BY_NAME(N'web.ArchiveArticle', N'OBJECT', N'EXECUTE'), 0) <> 1
   OR ISNULL(HAS_PERMS_BY_NAME(N'web.DeleteArticle', N'OBJECT', N'EXECUTE'), 0) <> 1
...
IF ISNULL(HAS_PERMS_BY_NAME(N'web.BlogPosts', N'OBJECT', N'SELECT'), 0) <> 0
   ...
   OR ISNULL(HAS_PERMS_BY_NAME(N'web.BlogPosts', N'OBJECT', N'UPDATE'), 0) <> 0
   OR ISNULL(HAS_PERMS_BY_NAME(N'web.BlogPosts', N'OBJECT', N'DELETE'), 0) <> 0
   OR ISNULL(HAS_PERMS_BY_NAME(N'web.ArticleDrafts', N'OBJECT', N'SELECT'), 0) <> 0
   OR ISNULL(HAS_PERMS_BY_NAME(N'web.ArticleDrafts', N'OBJECT', N'INSERT'), 0) <> 0
   OR ISNULL(HAS_PERMS_BY_NAME(N'web.ArticleDrafts', N'OBJECT', N'UPDATE'), 0) <> 0
   OR ISNULL(HAS_PERMS_BY_NAME(N'web.ArticleDrafts', N'OBJECT', N'DELETE'), 0) <> 0
   OR ISNULL(HAS_PERMS_BY_NAME(N'web.BlogImages', N'OBJECT', N'SELECT'), 0) <> 0
   OR ISNULL(HAS_PERMS_BY_NAME(N'web.BlogImages', N'OBJECT', N'INSERT'), 0) <> 0
   OR ISNULL(HAS_PERMS_BY_NAME(N'web.BlogImages', N'OBJECT', N'UPDATE'), 0) <> 0
   OR ISNULL(HAS_PERMS_BY_NAME(N'web.BlogImages', N'OBJECT', N'DELETE'), 0) <> 0
